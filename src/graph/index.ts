...
// --- application (Phase 8 — internal, read-only BUSINESS-GRAPH FACADE, flag-gated) ---
export {
...
export type {
  BusinessGraphFacadeFlagConfig,
  BusinessGraphFeaturePolicy,
  ...
  BusinessGraphFacadeDeps,
  BusinessGraphFacadeFactoryConfig,
  BusinessGraphQueryServiceFactory,
} from "./application";

// --- runtime (Phase 10 — trusted identity, authorization mapping, access policy,
//     audit adapter, and the lazy composition/lifecycle; default-closed, UNWIRED) ---
export {
  ...
  RuntimeBusinessGraphPermissionAdapter,
  toSafeAuditEntry,
...
export type {
  BusinessGraphRuntimeRolloutPolicy,
  RuntimeGraphRoleGrant,
  RuntimeGraphRoleCapability,
