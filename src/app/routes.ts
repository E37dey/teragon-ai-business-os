...
export const APP_ROUTES: readonly AppRouteDef[] = [
  ...
  { path: "/customers/:id", navPath: "/customers/cu-1", title: "כרטיס לקוח", wave: 3, inNav: false },
  ...
  { path: "/agents/collaboration", navPath: "/agents/collaboration", title: "חדר התיאום של הסוכנים", wave: 5, inNav: true },
  ...
  { path: "/implementation", navPath: "/implementation", title: "תכנית ההטמעה", wave: 7, inNav: true },
  { path: "/personas", navPath: "/personas", title: "פרסונות ומסלולי הדרכה", wave: 7, inNav: true },
  { path: "/stage-gates", navPath: "/stage-gates", title: "Stage Gates · שערי מעבר וראיות", wave: 7, inNav: true },
  { path: "/training-materials", navPath: "/training-materials", title: "מרכז חומרי ההדרכה", wave: 7, inNav: true },
  { path: "/quick-start", navPath: "/quick-start", title: "התחלה מהירה ושימוש נכון", wave: 7, inNav: true },
  ...
  { path: "/administration", navPath: "/administration", title: "ניהול המערכת", wave: 4, inNav: true },
  { path: "/submission", navPath: "/submission", title: "מרכז ההגשה והראיות", wave: 7, inNav: true },
  { path: "/submission/presentation", navPath: "/submission/presentation", title: "מצגת ההגשה", wave: 7, inNav: true },
] as const;
