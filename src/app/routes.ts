...
export const APP_ROUTES: readonly AppRouteDef[] = [
  ...
  { path: "/courses", navPath: "/courses", title: "קורסים והכשרות", wave: 4, inNav: true },
  { path: "/service", navPath: "/service", title: "שירות ותיקונים", wave: 4, inNav: true },
  { path: "/printers", navPath: "/printers", title: "מדפסות וציוד", wave: 4, inNav: true },
  ...
  { path: "/memory", navPath: "/memory", title: "זיכרון מקומי", wave: 6, inNav: true },
