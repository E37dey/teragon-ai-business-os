...
- **Next = S9.2-A1d2a-1B2: manually execute one live customer run** — operator triggers `customer-live-acceptance` (workflow_dispatch) for a chosen commit; then S9.2-A1d2b visual acceptance. Still no contacts, no other domains, no migration 015.
