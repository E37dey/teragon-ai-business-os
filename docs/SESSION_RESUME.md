...
- **Next = S9.2-A1d2a-1B2: one authoritative live run** — dispatch `customer-live-acceptance` preflight_only=true → then full run; require preflight PASS + 12/12 + cleanup=ok. Then S9.2-A1d2b visual acceptance. No contacts, no other domains, no migration 015.
