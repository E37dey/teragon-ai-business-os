...
- **Next = S9.2-A1d2a-1B2: manually execute one live customer run** — trigger `customer-live-acceptance` on the NEW commit; require preflight PASS + 12/12 + cleanup=ok. Then S9.2-A1d2b visual acceptance. No contacts, no other domains, no migration 015.
